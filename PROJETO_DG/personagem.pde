...
void personagem() {
  ...
  // Desenhar personagem na nova casa 
  fill(255, 0, 0);
  beginShape(TRIANGLES);
  vertex(width/2, 350);
  vertex(width/2 + 10, 300);
  vertex(width/2 + 20, 350);
  endShape();

  fill(0, 0, 255);
  beginShape(TRIANGLES);
  vertex(width/2 - 50, 350);
  vertex(width/2 - 40, 300);
  vertex(width/2 - 30, 350);
  endShape();
  ...
  fill(0);
   noStroke();
   beginShape();
   vertex(triangleX, triangleY + 500);
   vertex(triangleX + 100, triangleY + 300);
   vertex(triangleX + 200, triangleY + 500);
   endShape();
   
   triangleX += random(-2,2);
   triangleY += random(-1, 1);
   
   if (triangleX < 0) triangleX = 0;
   if (triangleX > width - 200) triangleX = width - 200;
   if (triangleY < 550) triangleY = 550;
   if (triangleY > 500 - 200) triangleY = 500 - 200;*/
}
